...
export default class Flat extends Component {
	...
	componentDidMount() {
		...
		axios
			.get(
				`https://admin.jurajbasanda.com/wp-json/wp/v2/property/${this.props.match.params.id}`
			)
			.then(
				(res) =>
					this.setState({
		...
		if (inLoaded) {
			return (
				<section className='flat'>
					<h1>
						{flat.acf.title}, {flat.acf.location}, {flat.id}
					</h1>
						...
						<div className='info'>
							<table>
								<tbody>
									<tr>
										<td>Monthly rent:</td>
										<td>£ {flat.acf.price}.00</td>
									</tr>
									<tr>
										<td>Location:</td>
										<td>{flat.acf.location}</td>
									</tr>
									<tr>
										<td>Bedrooms:</td>
										<td>{flat.acf.bedroom}</td>
									</tr>
									<tr>
										<td>Bathrooms:</td>
										<td>{flat.acf.bathroom}</td>
									</tr>
									<tr>
										<td>Year built:</td>
										<td>2001</td>
					...
					<div className='more-info'>
						<div>
							<ul>
								...
								<li>
									<img src={flat.acf.energy} alt='' srcSet='' />
								</li>
							</ul>
						</div>
						<div className='interested'>
							...
							<p>
								Call to us{' '}
								<a href='tel:+020 0000 0000' className='call-btn'>
									020 0000 0000
								</a>
							</p>
							<Link to='/contact' className='offer-btn'>
								Make an offer
							</Link>
						</div>
					</div>
